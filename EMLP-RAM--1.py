...
class ActivateNet:
    ...
    def plot_embedding(self, index=0):
        ...
        for k in range(0, 1):
            ...
            plt.tight_layout()
            plt.savefig('embedding_emlp_ram_cata/embedding{0:04d}_emlp_ram_cata.png'.format(k), dpi=350)
            plt.close()
            ...
            plt.savefig('input_embedding_emlp-ram_cata/input_embedding_emlp-ram_cata.png'.format(index), dpi=390)
            plt.close()
        return
